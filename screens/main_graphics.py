...
def draw_player_health_mana_armor(screen: Screen, creature: Creature, start_x, start_y):
  ...
  pygame.draw.rect(screen.display, screen.tileset.HP_RED, (hp_x + 5, hp_y + 5, max(0, int(246 * percentage)), 23))
  ...
  if creature.mana > 0:
    ...
    pygame.draw.rect(screen.display, screen.tileset.MANA_BLUE, (mana_x + 5, mana_y + 6, max(0, int(246 * percentage)), 23))
