...
class CreatureFactory:
  ...
  def new_edward(self, x, y):
    ...
    creature.modify_stat("Awareness", 1)
    creature.modify_stat("Accuracy", 1)
  ...
  def new_goobert(self, x, y):
    ...
    creature.set_attributes(1,2,1)
    creature.set_misc_stats()
    creature.modify_stat("Unarmed", 2)
    creature.set_unarmed_stats(type="slashing")
  ...
  def new_harold(self, x, y):
    ...
    creature.set_misc_stats()
    creature.modify_stat("Endurance", 1)
    creature.modify_stat("Cleaving", 1)
